...
from eth2spec.test.helpers.constants import (
    PHASE0, GASPER_SIESTA,
    MINIMAL,
)
from eth2spec.test.helpers.gasper_siesta.fork import (
...
@with_phases(phases=[PHASE0], other_phases=[GASPER_SIESTA])
@spec_test
@with_state
...
def test_gasper_siesta_fork_random_mismatched_attestations(spec, phases, state):
    ...
    yield from run_fork_test(phases[GASPER_SIESTA], state_0)
